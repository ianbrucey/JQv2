...
export enum I18nKey {
  ...
  LEGAL_CASES$LETS_START_BUILDING = "LEGAL_CASES$LETS_START_BUILDING",
  LEGAL_CASES$CREATE_NEW_CASE = "LEGAL_CASES$CREATE_NEW_CASE",
  LEGAL_CASES$YOUR_CASES = "LEGAL_CASES$YOUR_CASES",
  LEGAL_CASES$CASE_TITLE = "LEGAL_CASES$CASE_TITLE",
  LEGAL_CASES$CASE_NUMBER = "LEGAL_CASES$CASE_NUMBER",
  LEGAL_CASES$DESCRIPTION = "LEGAL_CASES$DESCRIPTION",
  LEGAL_CASES$CASE_TITLE_PLACEHOLDER = "LEGAL_CASES$CASE_TITLE_PLACEHOLDER",
  LEGAL_CASES$CASE_NUMBER_PLACEHOLDER = "LEGAL_CASES$CASE_NUMBER_PLACEHOLDER",
  LEGAL_CASES$DESCRIPTION_PLACEHOLDER = "LEGAL_CASES$DESCRIPTION_PLACEHOLDER",
  LEGAL_CASES$TITLE_REQUIRED = "LEGAL_CASES$TITLE_REQUIRED",
  LEGAL_CASES$CREATE_CASE = "LEGAL_CASES$CREATE_CASE",
  LEGAL_CASES$CREATING = "LEGAL_CASES$CREATING",
  LEGAL_CASES$CREATE_ERROR = "LEGAL_CASES$CREATE_ERROR",
  LEGAL_CASES$NO_CASES_TITLE = "LEGAL_CASES$NO_CASES_TITLE",
  LEGAL_CASES$NO_CASES_DESCRIPTION = "LEGAL_CASES$NO_CASES_DESCRIPTION",
  LEGAL_CASES$CREATE_YOUR_FIRST_CASE = "LEGAL_CASES$CREATE_YOUR_FIRST_CASE",
  LEGAL_CASES$LOAD_ERROR = "LEGAL_CASES$LOAD_ERROR",
  LEGAL_CASES$CURRENT = "LEGAL_CASES$CURRENT",
  LEGAL_CASES$LAST_ACCESSED = "LEGAL_CASES$LAST_ACCESSED",
  LEGAL_CASES$NEVER_ACCESSED = "LEGAL_CASES$NEVER_ACCESSED",
  LEGAL_CASES$DRAFT_SYSTEM_READY = "LEGAL_CASES$DRAFT_SYSTEM_READY",
  LEGAL_CASES$OPENHANDS_LEGAL_DESCRIPTION = "LEGAL_CASES$OPENHANDS_LEGAL_DESCRIPTION",
  LEGAL_CASES$NOT_SURE_HOW_TO_START = "LEGAL_CASES$NOT_SURE_HOW_TO_START",
  LEGAL_CASES$READ_THIS = "LEGAL_CASES$READ_THIS",
  ...
  RUNTIME$LOCAL_RUNTIME = "RUNTIME$LOCAL_RUNTIME",
  RUNTIME$DOCKER_RUNTIME = "RUNTIME$DOCKER_RUNTIME",
  RUNTIME$LOCAL_DESCRIPTION = "RUNTIME$LOCAL_DESCRIPTION",
  RUNTIME$DOCKER_DESCRIPTION = "RUNTIME$DOCKER_DESCRIPTION",
